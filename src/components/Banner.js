...
export const Banner = () => {
  ...
  const toRotate = [ "Web Developer", "Blockchain Developer", "Cloud Enthusiast" ];
  const period = 2000;
          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Ksheetiz`} </h1>
                <h1><span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Blockchain Developer", "Cloud Enthusiast" ]'><span className="wrap">{text}</span></span></h1>
